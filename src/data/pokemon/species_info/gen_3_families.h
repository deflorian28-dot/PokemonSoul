...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_TORCHIC] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 16, SPECIES_TORKOAL}),
    },
    ...
    [SPECIES_MARSHTOMP] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 34, SPECIES_SWAMPERT}),
    },
    ...
    [SPECIES_SWAMPERT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_WATER_1),
        .abilities = { ABILITY_TORRENT, ABILITY_SWIFT_SWIM, ABILITY_SHEER_FORCE },
        .bodyColor = BODY_COLOR_BLUE,
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_SHROOMISH] =
    {
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_EFFECT_SPORE, ABILITY_POISON_POINT, ABILITY_REGENERATOR },
    #else
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_BRELOOM, CONDITIONS({IF_HOLD_ITEM, ITEM_TINY_MUSHROOM})}),
    },
    ...
    [SPECIES_BRELOOM] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 0, SPECIES_BRUTE_BONNET, CONDITIONS({IF_HOLD_ITEM, ITEM_BIG_MUSHROOM})}),
    },
    ...
    [SPECIES_TORKOAL] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 34, SPECIES_HEATRAN}),
    },
    ...
    [SPECIES_SPOINK] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_INSOMNIA, ABILITY_OWN_TEMPO, ABILITY_IRON_BARBS },
        .bodyColor = BODY_COLOR_BLACK,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 19, SPECIES_GRUMPIG}),
    },
    ...
    [SPECIES_GRUMPIG] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_INSOMNIA, ABILITY_OWN_TEMPO, ABILITY_IRON_FIST },
        .bodyColor = BODY_COLOR_PURPLE,
