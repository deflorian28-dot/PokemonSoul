...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_TYMPOLE] =
    {
        ...
        .abilities = { ABILITY_EFFECT_SPORE, ABILITY_LIQUID_OOZE, ABILITY_UNAWARE },
        .bodyColor = BODY_COLOR_BLUE,
...
#define COTTONEE_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_GRASS)
    ...
    [SPECIES_COTTONEE] =
    {
        ...
        .abilities = { ABILITY_FLUFFY, ABILITY_SWARM, ABILITY_SIMPLE },
        .bodyColor = BODY_COLOR_GREEN,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 14, SPECIES_WHIMSICOTT}),
    },
    ...
    [SPECIES_WHIMSICOTT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS, EGG_GROUP_FAIRY),
        .abilities = { ABILITY_FLUFFY, ABILITY_LEVITATE, ABILITY_SIMPLE },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_DWEBBLE] =
    {
        ...
        .abilities = { ABILITY_SHELL_ARMOR, ABILITY_RECKLESS, ABILITY_INTIMIDATE },
        .bodyColor = BODY_COLOR_RED,
